...
def train(_class_):
    ...
    model_save_root_path = "/content/drive/MyDrive/IIT-Jodhpur/Semester2/AML/assignments/assigment3/RD4AD/saved_models"
    if not os.path.exists(model_save_root_path):
      os.makedirs(model_save_root_path)
    torch.save(bn, f"{model_save_root_path}/bn.pt")
    torch.save(decoder, f"{model_save_root_path}/decoder.pt")
